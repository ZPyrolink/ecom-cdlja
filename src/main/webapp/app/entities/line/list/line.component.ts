...
import { EntityArrayResponseType, LineService } from '../service/line.service';
...
export class LineComponent implements OnInit {
  ...
  trackId = (item: ILine): number => this.lineService.getLineIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.lines = this.refineData(dataFromBody);
  }

  protected refineData(data: ILine[]): ILine[] {
