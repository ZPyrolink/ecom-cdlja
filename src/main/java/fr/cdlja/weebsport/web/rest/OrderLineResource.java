...
/**
 * REST controller for managing {@link fr.cdlja.weebsport.domain.OrderLine}.
 */
@RestController
    ...
    public ResponseEntity<OrderLine> partialUpdateOrderLine(
        ...
        Optional<OrderLine> result = orderLineRepository
            ...
            .map(existingOrderLine -> {
                ...
                if (orderLine.getAmountline() != null) {
                    existingOrderLine.setAmountline(orderLine.getAmountline());
                }
