...
import static fr.cdlja.weebsport.domain.OrderLineAsserts.*;
...
class OrderLineResourceIT {
    ...
    private static final Float DEFAULT_AMOUNTLINE = 1F;
    private static final Float UPDATED_AMOUNTLINE = 2F;
    ...
    public static OrderLine createEntity() {
        return new OrderLine().quantity(DEFAULT_QUANTITY).amountline(DEFAULT_AMOUNTLINE);
    }
    ...
    public static OrderLine createUpdatedEntity() {
        return new OrderLine().quantity(UPDATED_QUANTITY).amountline(UPDATED_AMOUNTLINE);
    }
    ...
    void getAllOrderLines() throws Exception {
        ...
        restOrderLineMockMvc
            ...
            .andExpect(jsonPath("$.[*].amountline").value(hasItem(DEFAULT_AMOUNTLINE.doubleValue())));
    }
    ...
    void getOrderLine() throws Exception {
        ...
        restOrderLineMockMvc
            ...
            .andExpect(jsonPath("$.amountline").value(DEFAULT_AMOUNTLINE.doubleValue()));
    }
    ...
    void putExistingOrderLine() throws Exception {
        ...
        updatedOrderLine.quantity(UPDATED_QUANTITY).amountline(UPDATED_AMOUNTLINE);
    ...
    void partialUpdateOrderLineWithPatch() throws Exception {
        ...
        partialUpdatedOrderLine.quantity(UPDATED_QUANTITY).amountline(UPDATED_AMOUNTLINE);
