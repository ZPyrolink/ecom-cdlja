...
import static fr.cdlja.weebsport.domain.OrderAsserts.*;
...
class OrderResourceIT {
    ...
    private static final Status DEFAULT_STATUS = Status.BASKET;
    private static final Status UPDATED_STATUS = Status.PAID;
    ...
    private static final MeansOfPayment DEFAULT_MEAN_OF_PAYMENT = MeansOfPayment.CB;
    private static final MeansOfPayment UPDATED_MEAN_OF_PAYMENT = MeansOfPayment.ONLINEPAYMENT;
    ...
    public static Order createEntity() {
        return new Order().status(DEFAULT_STATUS).date(DEFAULT_DATE).amount(DEFAULT_AMOUNT).meanOfPayment(DEFAULT_MEAN_OF_PAYMENT);
    }
    ...
    public static Order createUpdatedEntity() {
        return new Order().status(UPDATED_STATUS).date(UPDATED_DATE).amount(UPDATED_AMOUNT).meanOfPayment(UPDATED_MEAN_OF_PAYMENT);
    }
    ...
    void getAllOrders() throws Exception {
        ...
        restOrderMockMvc
            ...
            .andExpect(jsonPath("$.[*].meanOfPayment").value(hasItem(DEFAULT_MEAN_OF_PAYMENT.toString())));
    }
    ...
    void getOrder() throws Exception {
        ...
        restOrderMockMvc
            ...
            .andExpect(jsonPath("$.meanOfPayment").value(DEFAULT_MEAN_OF_PAYMENT.toString()));
    }
    ...
    void putExistingOrder() throws Exception {
        ...
        updatedOrder.status(UPDATED_STATUS).date(UPDATED_DATE).amount(UPDATED_AMOUNT).meanOfPayment(UPDATED_MEAN_OF_PAYMENT);
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.status(UPDATED_STATUS).meanOfPayment(UPDATED_MEAN_OF_PAYMENT);
    ...
    void fullUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.status(UPDATED_STATUS).date(UPDATED_DATE).amount(UPDATED_AMOUNT).meanOfPayment(UPDATED_MEAN_OF_PAYMENT);
